...
<div class="toolbar">
  <div class="chartButton">
    <button class="chartButton__button" onclick={createChart}
...
<div class="chartContainer">
  <div class="buttonContainer">
    <button
      class="pdf-download__button"
      id="pdf-download__button"
      onclick={downloadPDF}
      style={chartMade ? "display:flex;" : "display:none"}
    >
      <img
...
<style>
  ...
  .chart-delete__image:hover {
    filter: brightness(0) saturate(100%) invert(73%) sepia(100%) saturate(4%)
      hue-rotate(8deg) brightness(92%) contrast(87%);
  }
</style>
